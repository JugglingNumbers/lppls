    ...
    def _func_compute_nested_fits(self, args):
        ...
        for j in range(0, n_fits, inner_increment):
            ...
            if self.__class__.__name__ == 'LPPLSCMAES':
                ...
                tc, m, w, a, b, c, c1, c2, O, D, es_fbest = self.fit(max_iteration=2500, pop_size=4, obs=obs_shrinking_slice, logger=logger)
            else:
        ...
        return {'t1': t1, 't2': t2, 'p2': p2, 'res': res, 'es_fbest': es_fbest}
